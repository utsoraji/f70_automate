...
if __name__ == "__main__":
	# Example usage
	frame = build_frame(F70Command.ReadAllTemps)
	print(frame)
	
	print(CRC16_ansi.from_data(b'$TEA,23.5,24.0,22.8,').hex)
	print(CRC16_ansi.from_data(b'$TES,').hex)

	test_frame = b'$TEA,23.5,24.0,22.8,F70D\r'
	response = parse_frame(test_frame)
	print(response)

	test_frame = b'$TES,CF68\r'
	response = parse_frame(test_frame)
	print(response)
